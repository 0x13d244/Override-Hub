...
// https://raw.githubusercontent.com/mihomo-party-org/override-hub/main/yaml/ACL4SSR_Online_Full_WithIcon.yaml

const main = (config) => {
    const customRules = [
        "PROCESS-NAME,EXCEL.EXE,DIRECT",
        "PROCESS-NAME,ONENOTE.EXE,DIRECT",
